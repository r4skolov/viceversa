...
const partnersMain = document.querySelectorAll('[data-slider="partnersMain-slider"]');
partnersMain.forEach(item => slider(item, {
  slidesPerView: 'auto',
  loop: false,
  navigation: {
...
const sliderDirections = document.querySelectorAll('[data-slider="directions-slider"]');
sliderDirections.forEach(item => slider(item, {
  slidesPerView: 'auto',
  loop: false,
  watchSlidesProgress: true,
  navigation: {
    nextEl: '.directions-slider-next',
    prevEl: '.directions-slider-prev'
  },
  breakpoints: {
    768: {
...
const sliderWorks = document.querySelectorAll('[data-slider="works-slider"]');
sliderWorks.forEach(item => slider(item, {
  slidesPerView: 'auto',
  loop: false,
  navigation: {
...
const sliderRetail = document.querySelectorAll('[data-slider="retail-slider"]');
sliderRetail.forEach(item => slider(item, {
  slidesPerView: 'auto',
  loop: false,
  watchSlidesProgress: true,
  navigation: {
    nextEl: '.retail-slider-next',
    prevEl: '.retail-slider-prev'
  },
  breakpoints: {
    1280: {
      allowTouchMove: false
...
const sliderEcom = document.querySelectorAll('[data-slider="ecom-slider"]');
sliderEcom.forEach(item => slider(item, {
  slidesPerView: 'auto',
  loop: false,
  watchSlidesProgress: true,
  navigation: {
    nextEl: '.ecom-slider-next',
    prevEl: '.ecom-slider-prev'
  },
  breakpoints: {
    1280: {
      allowTouchMove: false
...
const sliderFinance = document.querySelectorAll('[data-slider="finance-slider"]');
sliderFinance.forEach(item => slider(item, {
  slidesPerView: 'auto',
  loop: false,
  watchSlidesProgress: true,
  navigation: {
    nextEl: '.finance-slider-next',
    prevEl: '.finance-slider-prev'
  },
  breakpoints: {
    1280: {
      allowTouchMove: false
...
const sliderTelecom = document.querySelectorAll('[data-slider="telecom-slider"]');
sliderTelecom.forEach(item => slider(item, {
  slidesPerView: 'auto',
  loop: false,
  watchSlidesProgress: true,
  navigation: {
    nextEl: '.telecom-slider-next',
    prevEl: '.telecom-slider-prev'
  },
  breakpoints: {
    1280: {
      allowTouchMove: false
...
const presentationSlider = document.querySelectorAll('[data-slider="presentation-slider"]');
presentationSlider.forEach(item => slider(item, {
  slidesPerView: 'auto',
  loop: false,
  autoplay: {
    delay: 5000,
  ...
  navigation: {
    nextEl: '.presentation-slider-next',
    prevEl: '.presentation-slider-prev'
  },
  pagination: {
    el: '.swiper-pagination',
    clickable: true,
    renderBullet(index, className) {
      return `<span class="${className}"> <span>Слайд ${index + 1}</span> </span>`;
    }
  },
  on: {
    init() {
...
const partnersMartketing = document.querySelectorAll('[data-slider="partnersMarketing-slider"]');
partnersMartketing.forEach(item => slider(item, {
  slidesPerView: 'auto',
  loop: false,
  navigation: {
    nextEl: '.partners-slider-next',
